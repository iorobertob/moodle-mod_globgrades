...
/**
 * The main mod_globgrades configuration form.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_globgrades_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        $mform->addElement('text', 'name', get_string('globgradesname', 'globgrades'), array('size' => '64'));
        ...
        $mform->addHelpButton('name', 'globgradesname', 'globgrades');
    ...
    function data_preprocessing(&$default_values) {
        if ($this->current->instance and !$this->current->tobemigrated) {
            ...
            file_prepare_draft_area($draftitemid, $this->context->id, 'mod_globgrades', 'content', 0, array('subdirs'=>true));
